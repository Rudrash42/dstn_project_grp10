...
# MAX_MODEL_LEN =   # Start with 16K max context to ensure it fits in memory, we will test up to 16K tokens

# 2. Test Parameters
# We will test these specific context lengths to find the break-even point
CONTEXT_LENGTHS = [1024, 2048, 4096, 6000, 7500, 8192, 9000, 10000, 11000, 12000, 13000, 14000, 15000]
